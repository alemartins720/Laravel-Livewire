...
class InlineComponent extends Component
{
    ...
    public function render()
    {
        ...
        <div>
          ...
          <p class="display-6 text-center text-info">O valor passado para o componente é: <strong class="text-warning">{{ $value }}</strong></p>
          <p class="display-6 text-center text-info">O valor passado para o componente é (PHP): <strong class="text-warning">{{ $php_value }}</strong></p>
        </div>
        HTML;
    }
}
